function getDishesAppetizersTemplate(indexDishes,menuCategories) {
    return `
...
function getDishesSaladsTemplate(indexDishes,menuCategories) {
    return `
    <div class="single-dish-selection space-between">
        <div class="dish-information">
            <h3>${menuDishes[menuCategories][indexDishes].name}</h3>
...
function getDishesPizzaTemplate(indexDishes,menuCategories) {
    return `
    <div class="single-dish-selection space-between">
        <div class="dish-information">
            <h3>${menuDishes[menuCategories][indexDishes].name}</h3>
...
function getDishesPastaTemplate(indexDishes,menuCategories) {
    return `
    <div class="single-dish-selection space-between">
        <div class="dish-information">
            <h3>${menuDishes[menuCategories][indexDishes].name}</h3>
...
function getDishesBurgerTemplate(indexDishes,menuCategories) {
    return `
    <div class="single-dish-selection space-between">
        <div class="dish-information">
            <h3>${menuDishes[menuCategories][indexDishes].name}</h3>
...
function getDishesDessertsTemplate(indexDishes,menuCategories) {
    return `
    <div class="single-dish-selection space-between">
        <div class="dish-information">
            <h3>${menuDishes[menuCategories][indexDishes].name}</h3>
...
function getBasketTemplate(indexDishes,menuCategories) {
    ...
    <div id="selected-dishes-basket">
        ...
        <div id="selected_amount_basket">
            <div><img id="trashDecreaseButtonBasket" src="./assets/icons/${icon}" alt="trashDecreaseButtonBasket"></div>
